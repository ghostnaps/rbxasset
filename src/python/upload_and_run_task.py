...
ROBLOX_CI_UNIVERSE_ID = os.environ["ROBLOX_CI_UNIVERSE_ID"]
ROBLOX_CI_PLACE_ID = os.environ["ROBLOX_CI_PLACE_ID"]
...
if __name__ == "__main__":
    universe_id = ROBLOX_CI_UNIVERSE_ID
    place_id = ROBLOX_CI_PLACE_ID
